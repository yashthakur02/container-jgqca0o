...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jgqca0o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jgqca0o.containers.anotherwebservice.com/
...
```
git clone git@github.com:yashthakur02/container-jgqca0o.git
cd container-jgqca0o
```
...
```
docker attach container-jgqca0o
```
